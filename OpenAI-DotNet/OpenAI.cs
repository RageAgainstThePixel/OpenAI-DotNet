...
namespace OpenAI_DotNet
{
    ...
    public class OpenAI
    {
        ...
        public OpenAI(Authentication auth = null, Engine engine = null)
        {
            ...
            {
                throw new AuthenticationException("You must provide API authentication.  Please refer to https://github.com/StephenHodgson/OpenAI-API-dotnet#authentication for details.");
            }
